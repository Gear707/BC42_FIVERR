...
function Header() {
  ...
  return (
    ...
    >
      <header className={styles.container} data-reactroot>
        <div className={styles.background}>
          <a
            href="/?source=top_nav"
            className="site-logo"
            data-uw-rm-brl="false"
            aria-label="www.fiverr.com"
            ...
            <ul className="navbar-nav">
              <li className="nav-item active">
                <a
                  ...
                  className={`nav-link ${styles.FiverrBusiness}`}
                  target="_blank"
                  data-uw-rm-brl="false"
                  aria-label="Fiverr Business - opens in new tab"
                  data-uw-rm-ext-link
                  uw-rm-external-link-id="https://www.fiverr.com/business?source=top_nav$fiverrbusiness"
                >
                  Fiverr Business
                </a>
              </li>
